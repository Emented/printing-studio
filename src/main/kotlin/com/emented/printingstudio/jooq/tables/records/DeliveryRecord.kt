...
open class DeliveryRecord() : UpdatableRecordImpl<DeliveryRecord>(Delivery.DELIVERY) {
     ...
     */
    constructor(id: Long? = null, type: Long? = null, status: Long? = null, creationTimestamp: OffsetDateTime? = null, updateTimestamp: OffsetDateTime? = null): this() {
        this.id = id
        this.type = type
        this.status = status
