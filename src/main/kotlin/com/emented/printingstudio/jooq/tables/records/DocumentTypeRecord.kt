...
open class DocumentTypeRecord() :
    UpdatableRecordImpl<DocumentTypeRecord>(DocumentType.DOCUMENT_TYPE),
    Record2<Long?, String?> {
    ...
    override fun field1(): Field<Long?> = DocumentType.DOCUMENT_TYPE.ID
    override fun field2(): Field<String?> = DocumentType.DOCUMENT_TYPE.VALUE
    override fun component1(): Long? = id
    override fun component2(): String? = value
    override fun value1(): Long? = id
    override fun value2(): String? = value

    override fun value1(value: Long?): DocumentTypeRecord {
        this.id = value
        return this
    }

    override fun value2(value: String?): DocumentTypeRecord {
        this.value = value
        return this
    }

    override fun values(value1: Long?, value2: String?): DocumentTypeRecord {
        this.value1(value1)
        this.value2(value2)
        return this
    }
